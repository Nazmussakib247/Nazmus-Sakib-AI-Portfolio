...
async function seed() {
  ...
  if (existingCerts.length === 0) {
    ...
    await db.insert(certificates).values([
      ...
      { title: "AI for Brainstorming and Planning", issuer: "Google", category: "Artificial Intelligence", orderIndex: 1, credentialUrl: linkedinCertUrl, thumbnailUrl: "/images/certificates/linkedin-cert-07.png", skillsGained: ["Artificial Intelligence", "AI-assisted Planning"], description: "Google credential in AI-assisted brainstorming and planning.", issueDate: new Date("2026-06-01") },
      { title: "AI Fundamentals", issuer: "Google", category: "Artificial Intelligence", orderIndex: 2, credentialUrl: linkedinCertUrl, thumbnailUrl: "/images/certificates/linkedin-cert-01.png", skillsGained: ["Artificial Intelligence"], description: "Google fundamentals credential covering core AI concepts.", issueDate: new Date("2026-06-01") },
      ...
      { title: "Version Control with Git", issuer: "Atlassian", category: "Developer Tools", orderIndex: 4, credentialUrl: linkedinCertUrl, thumbnailUrl: "/images/certificates/linkedin-cert-10.png", skillsGained: ["Git", "Version Control"], description: "Atlassian credential in Git-based version control workflows.", issueDate: new Date("2026-05-01") },
      { title: "Version Control", issuer: "Meta", category: "Developer Tools", orderIndex: 5, credentialUrl: linkedinCertUrl, thumbnailUrl: "/images/certificates/linkedin-cert-02.png", skillsGained: ["Version Control", "Collaboration"], description: "Meta credential in version control and collaborative development.", issueDate: new Date("2026-05-01") },
      { title: "Claude 101", issuer: "Anthropic", category: "Generative AI", orderIndex: 6, credentialUrl: linkedinCertUrl, thumbnailUrl: "/images/certificates/linkedin-cert-08.png", skillsGained: ["Generative AI", "Prompting"], description: "Anthropic introductory credential for Claude and generative AI workflows.", issueDate: new Date("2026-05-01") },
      { title: "Foundations of Data Science", issuer: "Google", category: "Data Science", orderIndex: 7, credentialUrl: linkedinCertUrl, thumbnailUrl: "/images/certificates/linkedin-cert-03.png", skillsGained: ["Data Science", "Analytics"], description: "Google foundation credential in data science concepts and practice.", issueDate: new Date("2026-05-01") },
      { title: "Think Again I: How to Understand Arguments", issuer: "Duke University", category: "Critical Thinking", orderIndex: 8, credentialUrl: linkedinCertUrl, thumbnailUrl: "/images/certificates/linkedin-cert-04.png", skillsGained: ["Critical Thinking", "Reasoning"], description: "Duke University credential focused on understanding and evaluating arguments.", issueDate: new Date("2026-05-01") },
      { title: "Introduction to Networking", issuer: "NVIDIA", category: "Networking", orderIndex: 9, credentialUrl: linkedinCertUrl, thumbnailUrl: "/images/certificates/linkedin-cert-06.png", skillsGained: ["Networking Fundamentals", "TCP/IP"], description: "NVIDIA credential covering networking fundamentals and TCP/IP concepts.", issueDate: new Date("2026-05-01") },
    ]);
