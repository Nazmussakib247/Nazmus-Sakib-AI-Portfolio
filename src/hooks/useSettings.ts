...
export const DEFAULT_SETTINGS: Record<string, string> = {
  heroBadge: 'AI ENGINEER · RAG · LLM SYSTEMS',
  ...
  navigationItems: '[{"label":"About","id":"about","section":"about"},{"label":"Projects","id":"projects","section":"projects"},{"label":"Experience","id":"experience","section":"experience"},{"label":"Academic Foundation","id":"academic-foundation","section":"academicFoundation"},{"label":"Skills","id":"skills","section":"skills"},{"label":"Awards","id":"awards","section":"awards"},{"label":"Blog","id":"blog","section":"blog"},{"label":"CV","id":"cv"},{"label":"Activity","id":"activity"},{"label":"Contact","id":"contact","section":"contact"}]',
