...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative h-[var(--portfolio-vh,100svh)] min-h-[var(--portfolio-vh,100svh)] w-full overflow-hidden lg:h-screen lg:min-h-0" style={{ background: '#05060f' }}>
