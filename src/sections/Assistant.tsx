...
export default function Assistant() {
  ...
  return (
    <div
            className="xervis-widget group fixed bottom-[calc(1.75rem+env(safe-area-inset-bottom))] right-3 z-[80] sm:bottom-[calc(2rem+env(safe-area-inset-bottom))] sm:right-7 lg:bottom-7"
