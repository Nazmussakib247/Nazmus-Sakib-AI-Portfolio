...
export default function Assistant() {
  ...
  return (
    <div
            className="xervis-widget group fixed bottom-[calc(14.5rem+env(safe-area-inset-bottom))] right-3 z-[80] sm:bottom-[calc(11.5rem+env(safe-area-inset-bottom))] sm:right-7 lg:bottom-7"
    ...
    >
      {open && (
        <div
          ...
          className="xervis-chat-panel fixed bottom-[calc(14.5rem+78px+0.75rem+env(safe-area-inset-bottom))] right-3 flex h-[min(520px,calc(100dvh-20.5rem))] w-[calc(100vw-1.5rem)] max-w-[390px] flex-col overflow-hidden rounded-[26px] border border-[#e8b923]/25 bg-[#080b17]/95 shadow-[0_24px_80px_rgba(0,0,0,0.65),0_0_45px_rgba(232,185,35,0.12)] backdrop-blur-2xl sm:bottom-[calc(11.5rem+90px+0.75rem+env(safe-area-inset-bottom))] sm:right-7 lg:bottom-[calc(1.75rem+90px+0.75rem)]"
        >
